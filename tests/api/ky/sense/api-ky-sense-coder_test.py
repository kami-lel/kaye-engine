...
def assert_pl_instruction_title(opt):
    assert "### programming_languages" in opt


def assert_pl_instruction1(opt):
    assert "Return a string containing the abbreviations" in opt


def assert_pl_instruction2(opt):
