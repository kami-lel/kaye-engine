...
def mountain_testee(world_testee):
    return UnitTestNode(
        ...
        lines=[
            ...
            (
                "The wind here carries the taste of iron and the echo of"
                " avalanches."
            ),
        ],
    )
...
def cave_testee(peak_testee):
    return UnitTestNode(
        ...
        lines=[
            ...
            (
                "Echoes travel in strange ways; footsteps may sound like two"
                " people when only one goes in."
            ),
        ],
    )
...
def market_testee(village_testee):
    return UnitTestNode(
        ...
        lines=[
            ...
            (
                "At night the square empties and the lamps leave puddles of"
                " light on the cobbles—footprints fade but stories linger."
            ),
        ],
    )
