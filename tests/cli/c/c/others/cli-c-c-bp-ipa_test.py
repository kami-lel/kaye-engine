"""
cli-c-c-bp-ipa_test.py

Unit Tests (using pytest) for:

creation of ``International Phonetic Alphabet.md``
"""
...
# constants  ###################################################################
MD_FILENAME = "international-phonetic-alphabet"
...
class TestHeader:  # ===========================================================
    ...
    def test_name(_, testee_header):
        assert "name: International Phonetic Alphabet" in testee_header

    def test_description(_, testee_header):
        assert any("IPA transcription" in line for line in testee_header)
