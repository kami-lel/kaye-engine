"""
cli-c-c-bp-role-tarot-reader_test.py

Unit Tests (using pytest) for:

creation of ``Tarot Reader.md``
"""
...
class TestHeader:  # ===========================================================
    ...
    def test_name(_, testee_header):
        assert "name: Tarot Reader" in testee_header

    def test_description(_, testee_header):
        assert any("tarot readings" in line for line in testee_header)
