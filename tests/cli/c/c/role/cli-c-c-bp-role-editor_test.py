"""
cli-c-c-bp-role-editor_test.py

Unit Tests (using pytest) for:

creation of ``Editor.md``
"""
...
class TestHeader:  # ===========================================================
    ...
    def test_name(_, testee_header):
        assert "name: Editor" in testee_header

    def test_description(_, testee_header):
        assert any("Revises user-provided text" in line for line in testee_header)
