"""
cli-c-c-bp-role-librarian_test.py

Unit Tests (using pytest) for:

creation of ``Librarian.md``
"""
...
class TestHeader:  # ===========================================================
    ...
    def test_name(_, testee_header):
        assert "name: Librarian" in testee_header

    def test_description(_, testee_header):
        assert any("academic reading notes" in line for line in testee_header)
