"""
cli-c-c-bp-role-secretary_test.py

Unit Tests (using pytest) for:

creation of ``Secretary.md``
"""
...
class TestHeader:  # ===========================================================
    ...
    def test_name(_, testee_header):
        assert "name: Secretary" in testee_header

    def test_description(_, testee_header):
        assert any("emails and messages" in line for line in testee_header)
