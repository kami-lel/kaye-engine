"""
cli-a-s-abbrs-starts-digits_test.py

Unit Tests (using pytest) for:

creation of ``abbr-starts-with-digits-0-9``
"""
...
SKILL_NAME = "abbr-starts-with-digits-0-9"
TESTEE_FILE_CONTENT = TESTEE_FILE_CONTENT_ALL["abbr-starts-with-digits"]
...
class TestHeader:  # ===========================================================
    ...
    def test_description(_, testee_header):
        assert assert_claude_header_line_description(
            "abbr-starts-with-digits-0-9", testee_header
        )

    def test_version(_, testee_header):
        assert any(VERSION_LINE_PATTERN.match(line) for line in testee_header)

    def test_not_user_invocable(_, testee_header):
        assert "user-invocable: false" in testee_header
