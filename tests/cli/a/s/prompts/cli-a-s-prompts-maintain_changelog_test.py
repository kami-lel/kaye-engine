"""
cli-a-s-prompts-maintain_changelog_test.py

Unit Tests (using pytest) for:

creation of ``maintain-changelog``
"""
...
class TestHeader:  # ===========================================================
    ...
    def test_description(_, testee_header):
        assert any(
            "add, fix, or reorganize entries" in line for line in testee_header
        )
