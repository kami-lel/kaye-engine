"""
cli-a-s-prompts-maintain_docs_test.py

Unit Tests (using pytest) for:

creation of ``maintain-docs``
"""
...
class TestHeader:  # ===========================================================
    ...
    def test_description(_, testee_header):
        assert any("update existing README" in line for line in testee_header)
...
class TestPrerequisite:  # ====================================================
    ...
    def test2(_, testee_content):
        assert assert_prerequisite_content_line(SKILL_NAME, testee_content, 2)

    def test3(_, testee_content):
        assert assert_prerequisite_content_line(SKILL_NAME, testee_content, 3)
