"""
cli-a-v-claude_md_test.py

Unit Tests (using pytest) for:

``python -m kaye claude vs-code-extension`` — verifies CLAUDE.md is created
directly in the exported folder with content equivalent to ``kaye claude u -c``.
"""
...
class TestContent:  # ===========================================================
    ...
    def test_md_add_format(self, claude_md_content, marker):
        assert marker in claude_md_content
