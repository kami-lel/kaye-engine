"""
cli-a-c-alts-claude-c_test.py

Unit Tests (using pytest) for:

CLI alias: ``python -m kaye claude c`` — verifies subprocess is invoked with
...
class TestCliCommand:  # =======================================================
    ...
    def test_command_invoked(
        ...
        assert "claude c" in called_command
