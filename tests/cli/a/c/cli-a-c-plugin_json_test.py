"""
cli-a-c-plugin_json_test.py

Unit Tests (using pytest) for:

``python -m kaye claude code`` — verifies the plugin.json manifest is
exported under ``plugins/kaye/.claude-plugin/`` with the expected content.
"""
