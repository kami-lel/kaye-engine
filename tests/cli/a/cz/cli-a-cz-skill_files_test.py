"""
cli-a-cz-skill_files_test.py

Unit Tests (using pytest) for:

``python -m kaye claude plugin -z`` — verifies all skill SKILL.md files are
exported under the plugin's ``skills/`` subfolder within the extracted .zip.
"""
