"""
cli-a-cz-alts-claude-p_test.py

Unit Tests (using pytest) for:

CLI alias: ``python -m kaye claude p -z`` — verifies subprocess is invoked
...
class TestCliCommand:  # =======================================================
    ...
    def test_command_invoked(
        ...
        command = cli_claude_command + "p -z "
        prepare_root_folder(
        ...
        assert "claude p -z" in called_command
