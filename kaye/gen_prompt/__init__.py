...
The supporting function ``get_prompt_corpus`` loads the prompt corpus
from the filesystem (``kaye/gen_prompt/prompt_corpus.md``) at runtime.
...
retrieves and loads a selected blueprint stored in
