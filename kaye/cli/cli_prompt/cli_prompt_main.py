...
from kaye.cli.cli_prompt.cli_prompt_show import register_cli_prompt_show_parser
from kaye.cli.cli_prompt.cli_prompt_generate import (
    register_cli_prompt_generate_parser,
)
